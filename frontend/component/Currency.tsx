import diamondSrc from "~frontend/assets/icon/diamond.png";
import goldSrc from "~frontend/assets/icon/gold.png";
import heartSrc from "~frontend/assets/icon/heart_filled.png";
import qiCoinSrc from "~frontend/assets/icon/qi-coin.png";
